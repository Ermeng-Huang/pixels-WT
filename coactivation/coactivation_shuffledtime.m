...
if ~isempty(postspk)
    ...
    suid_sess(~avail,:)=[];
    if ispc
        save(fullfile('F:','neupix','STP','coactivate','0628',sprintf('%s_stp_%s_%d_%d.mat',...
...
shuffle=["raw","shuffle20ms","shuffle100ms"];
